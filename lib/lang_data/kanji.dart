      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: '何', furigana: 'なに'),
            FuriText(text: 'が'),
            FuriText(text: '楽しい', furigana: '？', emphasize: true),
            FuriText(text: 'ですか？'),
          ],
          answer: 'たのしい',
        ),
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'て'),
            FuriText(text: '言えば', furigana: '？', emphasize: true),
            FuriText(text: 'いい'),
            FuriText(text: 'か'),
            FuriText(text: 'わからない'),
          ],
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: 'いくらか'),
            FuriText(text: '調べて', furigana: '？', emphasize: true),
            FuriText(text: 'くれる？'),
          ],
          answer: 'しらべて',
        ),
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '調子', furigana: '？し', emphasize: true),
            FuriText(text: 'が'),
            FuriText(text: '悪', furigana: 'わる'),
            FuriText(text: 'い'),
          ],
        ...
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'は'),
            FuriText(text: '調査', furigana: '？さ', emphasize: true),
            FuriText(text: 'しています'),
          ],
          answer: 'ちょうさ',
        )
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'な'),
            FuriText(text: '作業', furigana: '？ぎょう', emphasize: true)
          ],
          answer: 'さぎょう',
        ),
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: '何', furigana: 'なに'),
            FuriText(text: 'かを'),
            FuriText(text: '作る', furigana: '？', emphasize: true),
          ],
          answer: 'つくる',
        ),
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '作りかた', furigana: '？', emphasize: true),
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '何時', furigana: '？じ', emphasize: true),
            FuriText(text: 'ですか？'),
          ],
          answer: 'なんじ',
        ),
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '何か', furigana: '？', emphasize: true),
            FuriText(text: '食', furigana: 'た'),
            FuriText(text: 'べたい'),
          ],
          answer: 'なんか',
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '家具', furigana: '？ぐ', emphasize: true),
            FuriText(text: 'を'),
        ...
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '具体的', furigana: '？たいてき', emphasize: true),
            FuriText(text: 'な'),
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '地図', furigana: 'ち？', emphasize: true),
            FuriText(text: 'を'),
        ...
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '図書館', furigana: '？しょかん', emphasize: true),
            FuriText(text: 'で'),
            FuriText(text: '勉強', furigana: 'べんきょう'),
            FuriText(text: 'します'),
          ],
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'の'),
            FuriText(text: '事故', furigana: '？こ', emphasize: true),
            FuriText(text: 'が'),
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'たくさん'),
            FuriText(text: '使った', furigana: '？', emphasize: true),
          ],
          answer: 'つかった',
        ),
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: 'ご'),
            FuriText(text: '使用', furigana: '？よう', emphasize: true),
            FuriText(text: 'ください'),
          ],
          answer: 'しよう',
        )
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '会社', furigana: '？しゃ', emphasize: true),
            FuriText(text: 'に'),
            FuriText(text: '行', furigana: 'い'),
            FuriText(text: 'きます'),
          ],
        ...
        PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'に'),
            FuriText(text: '会おう', furigana: '？', emphasize: true),
            FuriText(text: 'か？'),
          ],
          answer: 'あおう',
        )
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'どこに'),
              FuriText(text: '住みたい', furigana: '？', emphasize: true),
  ...
  Kanji(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'ビール', furigana: 'beer'),
              FuriText(text: '一つ', furigana: '？', emphasize: true),
              FuriText(text: 'ください'),
            ],
            answer: 'ひとつ'),
      ]),
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'リンゴ'),
              FuriText(text: '二つ', furigana: '？', emphasize: true),
              FuriText(text: '食べた'),
            ],
            answer: 'ふたつ'),
        PhraseAnswer(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'が'),
              FuriText(text: '三つ', furigana: '？', emphasize: true),
              FuriText(text: 'もあります'),
            ],
            answer: 'みっつ'),
      ]),
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'が'),
              FuriText(text: '五つ', furigana: '？', emphasize: true),
              FuriText(text: 'しか'),
              FuriText(text: '見', furigana: 'み'),
              FuriText(text: 'えない'),
            ],
  ...
  Kanji(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: '十分', furigana: '？ぶん', emphasize: true),
              FuriText(text: '食', furigana: 'た'),
              FuriText(text: 'べた？'),
            ],
            answer: 'じゅうぶん'),
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'を'),
              FuriText(text: '買', furigana: 'か'),
              FuriText(text: 'いました', furigana: '？', emphasize: true),
            ],
            answer: 'あたらしい'),
        PhraseAnswer(
            // 新人が二人も入った
  ...
  Kanji(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: '中古', furigana: '？こ', emphasize: true),
              FuriText(text: 'の'),
              FuriText(text: '車', furigana: 'くるま'),
              FuriText(text: 'を'),
              FuriText(text: '買', furigana: 'か'),
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: '人', furigana: 'ひと'),
              FuriText(text: 'は'),
              FuriText(text: '寒がり', furigana: '？', emphasize: true),
              FuriText(text: 'です'),
            ],
            answer: 'さむがり'),
      ]),
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'が'),
              FuriText(text: '明かるい', furigana: '？', emphasize: true),
            ],
            answer: 'あかるい'),
        PhraseAnswer(
            // 明日は雨ですか？
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'お好み焼き', furigana: '？', emphasize: true),
              FuriText(text: '食', furigana: 'た'),
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: '人', furigana: 'ひと'),
              FuriText(text: 'が'),
              FuriText(text: '多いい', furigana: '？', emphasize: true),
            ],
            answer: 'おおいい'),
        PhraseAnswer(
            // 彼は多分来ない
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'は'),
              FuriText(text: '黒人', furigana: '？', emphasize: true),
              FuriText(text: 'です'),
            ],
            answer: 'こくじん'),
      ]),
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'は'),
              FuriText(text: '白人', furigana: '？', emphasize: true),
              FuriText(text: 'が'),
              FuriText(text: '多', furigana: 'おお'),
              FuriText(text: 'いい'),
            ],
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'ちゃんと'),
              FuriText(text: '聞いて', furigana: '？', emphasize: true),
            ],
            answer: 'きいて'),
        PhraseAnswer(
            // 何かを聞こえた
            ...
            phraseParts: [
              FuriText(text: '何', furigana: 'なに'),
              FuriText(text: 'かを'),
              FuriText(text: '聞こえた', furigana: '？', emphasize: true),
            ],
            answer: 'きこえた'),
      ]),
  Kanji(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: '中', furigana: 'なか'),
              FuriText(text: 'に'),
              FuriText(text: '入れて', furigana: '？', emphasize: true),
              FuriText(text: 'くれる？'),
            ],
            answer: 'いれて'),
      ]),
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'から'),
              FuriText(text: '出て', furigana: '？', emphasize: true),
            ],
            answer: 'でて'),
        PhraseAnswer(
            // 本を出しましょう
            ...
            phraseParts: [
              FuriText(text: '本', furigana: 'ほん'),
              FuriText(text: 'を'),
              FuriText(text: '出しましょう', furigana: '？', emphasize: true),
            ],
            answer: 'だしましょう'),
        PhraseAnswer(
            // 今日は出かけるよ!
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'ここに'),
              FuriText(text: '立って', furigana: '？', emphasize: true),
              FuriText(text: 'ください'),
            ],
            answer: 'たって'),
        PhraseAnswer(
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'ここに'),
              FuriText(text: '座って', furigana: '？', emphasize: true),
            ],
            answer: 'すわって'),
        PhraseAnswer(
            // 新幹線の座席
  ...
  Kanji(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'ゆっくり'),
              FuriText(text: '休んで', furigana: '？', emphasize: true),
              FuriText(text: 'ね')
            ],
            answer: 'やすんで'),
        PhraseAnswer(
  ...
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'どこに'),
              FuriText(text: '行く', furigana: '？', emphasize: true),
              FuriText(text: 'の？'),
            ],
            answer: 'いく'),
        // PhraseAnswer(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              ...
              FuriText(text: 'く'),
              FuriText(text: '来て', furigana: '？', emphasize: true),
              FuriText(text: 'ね'),
            ],
            answer: 'きて'),
      ]),
  Kanji(
      ...
      phraseAnswers: [
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'お帰り', furigana: '？', emphasize: true),
              FuriText(text: 'なさい'),
            ],
            answer: 'おかえり'),
        PhraseAnswer(
  ...
  Kanji(
      ...
      phraseAnswers: [
        ...
        PhraseAnswer(
            ...
            phraseParts: [
              FuriText(text: 'メニューを'),
              FuriText(text: '開いて', furigana: '？', emphasize: true),
            ],
            answer: 'ひらいて'),
      ]),
  Kanji(
    ...
    phraseAnswers: [
      PhraseAnswer(
          ...
          phraseParts: [
            ...
            FuriText(text: 'から'),
            FuriText(text: '分ける', furigana: '？', emphasize: true)
          ],
          answer: 'わける'),
      PhraseAnswer(
          // あと十分待ってね
          ...
          phraseParts: [
            FuriText(text: 'あと'),
            FuriText(text: '十分', furigana: '？', emphasize: true),
            FuriText(text: 'まってね'),
          ],
          answer: 'じゅうぷん'),
      PhraseAnswer(
          ...
          phraseParts: [
            FuriText(text: '日本語', furigana: 'にほんご'),
            FuriText(text: 'が'),
            FuriText(text: '分かる', furigana: '？', emphasize: true),
          ],
          answer: 'わかる'),
    ],
  ),
