...
var doushiBank = [
  ...
  Doushi(
    ...
    casual: DoushiConj(
        ...
        negativeTeForm: (JWord(kanaWord: "あげないで", kanjiWord: "あげないで"))),
  ),
  Doushi(
    isIrregular: false,
    infinitive: 'もらう',
    ...
    casual: DoushiConj(
        ...
        negativeTeForm: (JWord(kanaWord: "もらわないで", kanjiWord: "もらわないで"))),
  ),
  Doushi(
    isIrregular: false,
    infinitive: '終わる',
  ...
  Doushi(
    ...
    casual: DoushiConj(
        ...
        negativeTeForm: (JWord(kanaWord: "しないで", kanjiWord: "しないで"))),
  ),
  Doushi(
    isIrregular: true,
    infinitive: '歩く',
